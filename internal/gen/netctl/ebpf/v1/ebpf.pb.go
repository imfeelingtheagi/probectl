...
// 	protoc        (unknown)
// source: netctl/ebpf/v1/ebpf.proto
...
type Flow struct {
	...
	TenantId           string `protobuf:"bytes,1,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`                                    // -> "netctl.tenant.id" (outermost scope, F50)
	AgentId            string `protobuf:"bytes,2,opt,name=agent_id,json=agentId,proto3" json:"agent_id,omitempty"`                                       // -> "netctl.agent.id"
...
func (x *Flow) Reset() {
	*x = Flow{}
	mi := &file_netctl_ebpf_v1_ebpf_proto_msgTypes[0]
...
func (*Flow) Descriptor() ([]byte, []int) {
	return file_netctl_ebpf_v1_ebpf_proto_rawDescGZIP(), []int{0}
}
...
func (x *ServiceEdge) Reset() {
	*x = ServiceEdge{}
	mi := &file_netctl_ebpf_v1_ebpf_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ServiceEdge) Descriptor() ([]byte, []int) {
	return file_netctl_ebpf_v1_ebpf_proto_rawDescGZIP(), []int{1}
}
...
var File_netctl_ebpf_v1_ebpf_proto protoreflect.FileDescriptor

const file_netctl_ebpf_v1_ebpf_proto_rawDesc = "" +
	"\n" +
	"\x19netctl/ebpf/v1/ebpf.proto\x12\x0enetctl.ebpf.v1\"\xd1\x04\n" +
	"\x04Flow\x12\x1b\n" +
...
var (
	...
	file_netctl_ebpf_v1_ebpf_proto_rawDescData []byte
)

func file_netctl_ebpf_v1_ebpf_proto_rawDescGZIP() []byte {
	file_netctl_ebpf_v1_ebpf_proto_rawDescOnce.Do(func() {
		file_netctl_ebpf_v1_ebpf_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_netctl_ebpf_v1_ebpf_proto_rawDesc), len(file_netctl_ebpf_v1_ebpf_proto_rawDesc)))
	})
...
func file_netctl_ebpf_v1_ebpf_proto_init() {
	if File_netctl_ebpf_v1_ebpf_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_netctl_ebpf_v1_ebpf_proto_goTypes,
		DependencyIndexes: file_netctl_ebpf_v1_ebpf_proto_depIdxs,
		MessageInfos:      file_netctl_ebpf_v1_ebpf_proto_msgTypes,
	}.Build()
	File_netctl_ebpf_v1_ebpf_proto = out.File
	file_netctl_ebpf_v1_ebpf_proto_goTypes = nil
	file_netctl_ebpf_v1_ebpf_proto_depIdxs = nil
}

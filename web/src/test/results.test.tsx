  ...
  return [
    {
      ...
      metrics: {
        ...
        'http.total.ms': 450,
        'http.status': 200,
        'http.throughput.kbps': 1800,
        'http.content.bytes': 102400,
        'http.tls.cert_expiry_days': 42,
      },
    },
    {
      agent_id: 'a1',
      ...
      attributes: {
        'dns.rcode': 'NOERROR',
        'dns.answer': '203.0.113.10, 203.0.113.11',
    ...
    },
    {
      ...
      metrics: {
        'voice.mos': 3.1,
        'voice.r_factor': 61.4,
        'voice.jitter.ms': 12.42,
        'voice.one_way.ms': 96.5,
        'voice.loss.pct': 8.5,
        'loss.ratio': 0.085,
        'packets.sent': 150,
